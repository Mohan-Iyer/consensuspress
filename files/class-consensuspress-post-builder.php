...
class ConsensusPress_Post_Builder {
	...
	public function create_draft( array $api_data, string $mode = 'create' ): array {
		...
		// ------------------------------------------------------------------
		// 7. Featured image — empty array in Sprint 7 (Unsplash deferred Sprint 8).
		//    sideload_featured_image() preserved unchanged; skipped when no URL.
		// ------------------------------------------------------------------
	 ...
	 * Unsplash integration deferred to Sprint 8 (D-08-07).
	 *
	 * @param int   $post_id        WordPress post ID.
